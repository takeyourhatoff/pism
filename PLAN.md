...
* ✅ Completed:
  ...
  * Added device-resident GMRES inner loop (device Hessenberg/Givens, deferred convergence checks) with new config keys; benchmarked std-greenland 4y: default config 98.92s → 90.08s (~8.9% faster), tuned 4y config 10.13s → 10.11s (no meaningful change).
